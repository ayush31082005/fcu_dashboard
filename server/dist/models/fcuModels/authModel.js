...
exports.recordFcuActivity = exports.updateLastLogin = exports.findFcuUserByEmail = exports.createFcuUser = void 0;
...
const recordFcuActivity = async (userId, action, ipAddress, userAgent) => {
    return db_1.default.query('INSERT INTO fcu_login_activity (fcu_user_id, action, ip_address, user_agent) VALUES (?, ?, ?, ?)', [userId, action, ipAddress, userAgent]);
};
exports.recordFcuActivity = recordFcuActivity;
