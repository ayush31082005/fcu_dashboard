...
const cases = [
  ...
  { lead: 'FCU-SEED-1005', mobile: '9000011005', name: 'Anjali Yadav', email: 'anjali.yadav@test.in', amount: 85000, purpose: 'Personal Loan', city: 'Gurugram', state: 'Haryana', company: 'Vertex Solutions Pvt Ltd', income: 46000, pan: 'ABCDE1005K', aadhaar: '700000001005', cibil: 734, bank: 'HDFC Bank' },
  { lead: 'FCU-SEED-1006', mobile: '9000011006', name: 'Vikram Singh', email: 'vikram.singh@test.in', amount: 110000, purpose: 'Business Loan', city: 'Noida', state: 'Uttar Pradesh', company: 'Northstar Traders', income: 55000, pan: 'ABCDE1006L', aadhaar: '700000001006', cibil: 742, bank: 'ICICI Bank' },
  { lead: 'FCU-SEED-1007', mobile: '8423573070', name: 'Rohit Sharma', email: 'rohit.sharma@test.in', amount: 95000, purpose: 'Personal Loan', city: 'Lucknow', state: 'Uttar Pradesh', company: 'Apex Services Pvt Ltd', income: 48000, pan: 'ABCDE1007M', aadhaar: '700000001007', cibil: 726, bank: 'HDFC Bank' },
  { lead: 'FCU-SEED-1008', mobile: '9971222197', name: 'Priya Verma', email: 'priya.verma@test.in', amount: 135000, purpose: 'Education Loan', city: 'New Delhi', state: 'Delhi', company: 'Bright Future Academy', income: 62000, pan: 'ABCDE1008N', aadhaar: '700000001008', cibil: 751, bank: 'Axis Bank' },
];
